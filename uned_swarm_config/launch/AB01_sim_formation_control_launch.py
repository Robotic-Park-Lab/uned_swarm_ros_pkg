...
def generate_launch_description():
    ...
    webots = WebotsLauncher(
        world=os.path.join(config_package_dir, 'worlds', 'AB01_RoboticPark_n14.wbt')
    )
    ...
    vicon_node = Node(
        ...
        parameters=[
            {'use_sim_time': use_sim_time},
            {"agents": 'dron01, dron02, dron03, dron04, dron05, dron06, dron07, dron08, dron09, dron10, dron11, dron12, dron13, dron14'},
        ]
    )
