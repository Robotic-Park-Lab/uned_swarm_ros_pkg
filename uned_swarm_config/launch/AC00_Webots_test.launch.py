...
def generate_launch_description():
    ...
    config_path = os.path.join(general_package_dir, 'resources', 'AC00_RoboticPark.yaml')
    ...
    webots = WebotsLauncher(
        world=os.path.join(general_package_dir, 'worlds', 'AC20_RoboticPark.wbt')
    )
    ...
    cpu_measure = Node(
        ...
        output='screen',
        parameters=[{
             'process_name' : 'webots-bin, ros2, driver, swarm_driver, rviz2, kheperaIV_clien',
             'process_period' : 0.5},
        ],
    )
