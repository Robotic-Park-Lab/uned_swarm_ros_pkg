...
def generate_launch_description():
    ...
    dron_config_path = os.path.join(swarm_package_dir, 'resources', 'crazyflie_n4_formation_distance.yaml')
    ...
    swarm_node = Node(
        ...
        parameters=[
            ...
            {'controller_type': 'EventBased, Continuous, EventBased, Continuous'},
